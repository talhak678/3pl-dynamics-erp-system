  ...
  return `
    <div>
        ...
        <body data-id="__react-email-body">
            ...
            <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0">We have received a request to reset the password for your 3PL Dynamics account. To proceed with the password reset, please click on the link provided below:</p>
